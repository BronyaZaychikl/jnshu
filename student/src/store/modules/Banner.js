...
const banner = {
    ...
    getters: {
        monitorBanner:state=>state.banner
    },
    ...
    actions: {
        ...
        bannerVideo(context) {
            axios({
                ...
                context.commit('changeBanner', res.data.data)
                window.console.log(context.state.banner);
            }).catch(err => {
                window.console.log(err);
            })
        },
        bannerArticle(context) {
            axios({
                method: 'get',
                url: 'a/banners/article',
